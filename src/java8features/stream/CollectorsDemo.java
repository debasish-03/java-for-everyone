...
public class CollectorsDemo {
    public static void main(String[] args) {
        ...
        Set<Integer> collect = nums.stream().map(x -> x * 2).collect(Collectors.toSet());
        System.out.println(collect);

        // 3. Collecting to a Specific Collection
        ArrayDeque<String> collect1 = names.stream().map(String::toUpperCase).collect(Collectors.toCollection(ArrayDeque::new));
